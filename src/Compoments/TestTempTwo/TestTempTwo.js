...
import './Test.css';
import quizQuestionsTempTwo from "./api/quizQuestionsTempTwo";



class TestTempTwo extends Component {
  ...
  getResults() {
    ...
    const extra =answersCount.Екстраверсія;
    const nejro =answersCount.Нейротизм;
    const pshyho = answersCount.Психотизм;
    const lie = answersCount.Брехня;

    const maxAnswerCount = Math.max.apply(null, answersCountValues);
    console.log(answersCount.Екстраверсія);
    console.log(answersCount.Нейротизм);
    console.log(answersCount.Психотизм);
    ...
    return [ extra,nejro,pshyho,lie,answersCountKeys.filter(key => answersCount[key] === maxAnswerCount),
    ]
  }
