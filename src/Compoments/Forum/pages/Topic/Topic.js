    ...
    API.post(
      ...
      .then(result => {
        ...
        if (recentPageNumber === currentPage) {
          ...
          history.push(`/recruting/forum/topic?sid=${shortid}&page=${recentPageNumber}`);
        }
      })
      .catch(e => {
        setLoading(false);
  ...
  const fetchPage = page => {
    ...
    API.get(`/topics?sid=${shortid}&page=${page}`)
      .then(result => {
        ...
        history.push(`/recruting/forum/topic?sid=${shortid}&page=${page}`);
      })
      .catch(e => {
        Modal.error({
          title: 'An error occurred',
          ...
          {loading ? (
            ...
            <div className={styles.Topic}>
              <div className={styles.Header}>
                ...
                }} to={`/recruting/forum/subcategory?sid=${topic.subcategory.shortid}`}>
