...
export default class TestProfDef extends Component {
    ...
    render() {
      ...
      <span>
        ...
        Инструкция.Внимательно прочтите приведенные ниже утверждения и оцените их по критерию соответствия или несоответствия вашему собственному поведению. Если утверждение в большинстве случаев относится к Вам, Вы ставите оценку «Да». Если оно редко совпадает с Вашим настоящим поведением, Вы ставите оценку «Нет».
        </span>
