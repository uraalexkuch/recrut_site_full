...
import TestTemp from "../TestTemp/TestTemp";
import TestTempTwo from "../TestTempTwo/TestTempTwo";
import "./Presentaion.css"
const data=dataFull.slice(23,27)




export default class PresentaionBlock4     extends Component {
        ...
        return (trennig ?
                        ...
                        return(
                            <div  key={presentation.id}
                                ...
                                <Card style={{
                                    ...
                                    <img  className="history col-md-6"  style={{
                                    }}
           ...
           :
                <div style={{
                    ...
                    <span>Тест по Бєлову</span>
                    <TestTemp/>
                    <span>Тест по Айзенку</span>
                    <TestTempTwo/>
                </div>
                    <span style={{
                        marginLeft: "20%",
