...
export default class TestEmotionBrain extends Component {
    ...
    getResults=()=> {
     ...
     //   const answersCountKeys = Object.keys(answersCount);
      ...
      //  const answersCountValues=  answersCountValuesOld.filter(key => answersCount[key]==='Эмоциональная_осведомленность1');
        const answersCountValues1=  answersCount.Эмоциональная_осведомленность1;
        const answersCountValues2= answersCountValuesOld.filter((key) => {
            return key === answersCount.Эмоциональная_осведомленность2?answersCount.Эмоциональная_осведомленность2:0});
        const answersCountValues3= answersCountValuesOld.filter((key) => {
            return key === answersCount.Эмоциональная_осведомленность3?answersCount.Эмоциональная_осведомленность3:0});
        const answersCountValues4= answersCountValuesOld.filter((key) => {
            return key === answersCount.Эмоциональная_осведомленность4?answersCount.Эмоциональная_осведомленность4:0});
        const answersCountValues5= answersCountValuesOld.filter((key) => {
            return key === answersCount.Эмоциональная_осведомленность5?answersCount.Эмоциональная_осведомленность5:0});
        const answersCountValues6= answersCountValuesOld.filter((key) => {
            return key === answersCount.Эмоциональная_осведомленность6?answersCount.Эмоциональная_осведомленность6:0});
        const sum=answersCountValues2.map((key) => {
            return key *(-3)});

        const sum11=answersCountValues2.map((key) => {
            return key *(-2)});
        const sum1=sum.reduce(function(acc, val) { return acc + val; }, 0)
        const sum2=sum11.reduce(function(acc, val) { return acc + val; }, 0)*/
       // const answersCountValues2= answersCountKeys.map(key =>{  return key === answersCount.Эмоциональная_осведомленность1?answersCount[key]:0});
